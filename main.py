...
async def main(page:ft.Page):
    ...
    page.theme = ft.Theme(name2hex(await page.client_storage.get_async(f"{NS}.theme")) or "cyan")
    page.theme_mode = ft.ThemeMode(await page.client_storage.get_async(f"{NS}.mode") or "dark")
